...
Event.register(window,"load",function() {
	var lightbox = new LightBox({
		loadingimg:'<?=$WEB_ROOT?>/loading.gif',
		expandimg:'<?=$WEB_ROOT?>/expand.gif',
		shrinkimg:'<?=$WEB_ROOT?>/shrink.gif',
		previmg:'<?=$WEB_ROOT?>/prev.gif',
		nextimg:'<?=$WEB_ROOT?>/next.gif',
//		effectimg:'zzoop.gif',
//		effectpos:{x:-40,y:-20},
//		effectclass:'effectable',
		closeimg:'<?=$WEB_ROOT?>/close.gif',
		resizable:true
	});
});
