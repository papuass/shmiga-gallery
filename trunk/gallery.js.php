...
?>
		...
		objImageCommentsForm.appendChild(objImageCommentsName);
		...
		objImageCommentsForm.appendChild(objImageCommentsTextLabel);
		...
		objImageCommentsForm.appendChild(objImageCommentsText);
		...
		objImageCommentsForm.appendChild(objImageCommentsSubmit);
...
//</div>
	...
	submitComment: function() {
		if ($F('imageCommentsName').match(/^\s*$/)) {
			...
			alert('Ievadiet komentāra tekstu!');
